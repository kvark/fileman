    ...
    pub fn colors(&self) -> ThemeColors {
        ...
        match self.kind {
            ThemeKind::Dark => ThemeColors {
                ...
                panel_border_active: Color::rgba(0.42, 0.72, 1.0, 1.0),
                panel_border_inactive: Color::rgba(0.20, 0.22, 0.28, 1.0),
                header_bg: Color::rgba(0.16, 0.20, 0.30, 1.0),
                header_fg: Color::rgba(0.95, 0.97, 1.0, 1.0),
                footer_bg: Color::rgba(0.09, 0.10, 0.14, 1.0),
                footer_fg: Color::rgba(0.72, 0.78, 0.86, 1.0),
                preview_bg: Color::rgba(0.07, 0.08, 0.11, 1.0),
                preview_header_bg: Color::rgba(0.12, 0.14, 0.19, 1.0),
                preview_header_fg: Color::rgba(0.90, 0.94, 1.0, 1.0),
            ...
            ThemeKind::Light => ThemeColors {
                ...
                panel_border_active: Color::rgba(0.20, 0.50, 0.88, 1.0),
                panel_border_inactive: Color::rgba(0.82, 0.84, 0.88, 1.0),
                header_bg: Color::rgba(0.30, 0.50, 0.78, 1.0),
                header_fg: Color::rgba(0.99, 0.99, 1.0, 1.0),
                footer_bg: Color::rgba(0.93, 0.95, 0.97, 1.0),
                footer_fg: Color::rgba(0.28, 0.32, 0.42, 1.0),
                preview_bg: Color::rgba(0.985, 0.985, 0.99, 1.0),
...
fn load_themes_from_dir(dir: &std::path::Path) -> Vec<(String, ThemeColors)> {
    ...
    candidates.sort_by_key(|a| a.0.to_ascii_lowercase());
