    ...
    pub fn colors(&self) -> ThemeColors {
        ...
        match self.kind {
            ThemeKind::Dark => ThemeColors {
                divider: Color::rgba(0.2, 0.2, 0.2, 1.0),
                row_bg_selected_active: Color::rgba(0.2, 0.4, 0.7, 1.0),
                row_bg_selected_inactive: Color::rgba(0.15, 0.3, 0.5, 1.0),
                row_fg_selected: Color::rgba(1.0, 1.0, 1.0, 1.0),
                row_fg_active: Color::rgba(0.9, 0.9, 0.9, 1.0),
                row_fg_inactive: Color::rgba(0.7, 0.7, 0.7, 1.0),
                panel_border_active: Color::rgba(0.2, 0.6, 0.9, 1.0),
                panel_border_inactive: Color::rgba(0.1, 0.1, 0.1, 1.0),
                header_bg: Color::rgba(0.75, 0.75, 0.75, 1.0),
                header_fg: Color::rgba(0.0, 0.0, 0.0, 1.0),
                footer_bg: Color::rgba(0.15, 0.15, 0.15, 1.0),
                footer_fg: Color::rgba(0.8, 0.8, 0.8, 1.0),
                preview_bg: Color::rgba(0.08, 0.08, 0.08, 1.0),
                preview_header_bg: Color::rgba(0.2, 0.2, 0.2, 1.0),
                preview_header_fg: Color::rgba(1.0, 1.0, 1.0, 1.0),
                preview_text: Color::rgba(0.95, 0.95, 0.95, 1.0),
            },
            ThemeKind::Light => ThemeColors {
                divider: Color::rgba(0.85, 0.85, 0.85, 1.0),
                row_bg_selected_active: Color::rgba(0.75, 0.85, 1.0, 1.0),
                row_bg_selected_inactive: Color::rgba(0.85, 0.9, 1.0, 1.0),
                row_fg_selected: Color::rgba(0.0, 0.0, 0.0, 1.0),
                row_fg_active: Color::rgba(0.1, 0.1, 0.1, 1.0),
                row_fg_inactive: Color::rgba(0.3, 0.3, 0.3, 1.0),
                panel_border_active: Color::rgba(0.2, 0.6, 0.9, 1.0),
                panel_border_inactive: Color::rgba(0.8, 0.8, 0.8, 1.0),
                header_bg: Color::rgba(0.95, 0.95, 0.95, 1.0),
                header_fg: Color::rgba(0.05, 0.05, 0.05, 1.0),
                footer_bg: Color::rgba(0.92, 0.92, 0.92, 1.0),
                footer_fg: Color::rgba(0.2, 0.2, 0.2, 1.0),
                preview_bg: Color::rgba(1.0, 1.0, 1.0, 1.0),
                preview_header_bg: Color::rgba(0.92, 0.92, 0.92, 1.0),
                preview_header_fg: Color::rgba(0.1, 0.1, 0.1, 1.0),
                preview_text: Color::rgba(0.1, 0.1, 0.1, 1.0),
            },
        }
    }
